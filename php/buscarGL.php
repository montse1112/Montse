<?php
    ...
    function ejecuta_consulta($id)
    {
       //hacer la conexion a la base de datos
        ...
        //consulta de select
        $query1=mysqli_query($getconex, "SELECT id, id_distribuidor, marca, color, pulgadas, cantidad_globos, precio, stock, url_img FROM globoslatex WHERE id ='$id'");
...
<header>
    ...
    <br>
    <p class='t2 azulP'>Buscar globo por ID</p>
    <p class='parrafo'>ID</p>
    <input type='text' placeholder='ID' name='buscar'>

    <br>
    <br>
    <input type='submit' name='buscarGL' value='Buscar globo latex'>
    </form>
    ...
    ?>
                ...
                <tbody>
                    ...
                    if (isset($cm) && !empty($cm)) {
                        ...
                        <tr>
                            ...
                            <td><?php echo $cortinaM['cantidad_globos'] ?></td>
                            <td><?php echo "<form action='actualizarGL.php' method='POST' enctype='multipart/form-data'>";
                            ...
                            <td><?php echo '<p><img src="../images_GL/'.$url.'"  height=200 width=250></p>';
        ...
        <?php
                        echo "<br>";
                        echo "<center><input type='submit' name='actualizarGL' value='Actualizar globo latex' /></center>";
                        echo "</form>"; 
                        ...
                        if (isset($cm) && !empty($cm)) {
                            ...
                            foreach ($cm as $cortinaM) {
                                ...
                                ?>
                            <tr>  
                                <td><?php echo "<form action='eliminarGL.php' method='POST' enctype='multipart/form-data'>";
                                echo "<input type='hidden' name='id' value='$idGL'> <br/> <br/>";
                                ?></td>
                            </tr>
                        ...
                        echo "<center><input type='submit' name='eliminarGL' value='Eliminar globo' /></center>";
                        echo "</form>";
                        ?>
    <?php
        } 
